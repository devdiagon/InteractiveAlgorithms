...
namespace AlgoritmosInteractivos.interactions
{
    internal class BresHandler
    {
        ...
        public BresHandler(PictureBox picCanvas)
        {
        ...
        private void PlotPoint(Point p)
        {
            ...
            g.FillEllipse(Brushes.Blue, circ);
        ...
        {
            Bresenham = new BresenhamLine(pIni, pEnd);
            totalPoints = Bresenham.GeneratePoints();
        }
